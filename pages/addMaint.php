				...
				<div class="row col-12 col-lg-12">
					...
					<div class="card radius-10">
						<div class="card-body">
							...
							<form class="row g-3 pt-5" id="addAsset" method="POST" action="index.php?p=insertMainStartegy">
										<div class="col-md-6">
											<label for="input1" class="form-label">Maintenance Strategy</label>
											<select class="form-select" name="mainstrat" id="mainstrat" required>
										...
										<div class="col-md-6">
											<label for="input2" class="form-label">Task</label>
											<input type="text" class="form-control" name="task" id="task" placeholder="Task" required>
										</div>
										<div class="col-md-6">
