				...
				<div class="row col-12 col-lg-12">
					...
					<div class="card radius-10">
						<div class="card-body">
							...
							<form class="row g-3 pt-5" id="addAsset" method="POST" action="index.php?p=insertOrder">
										<div class="col-md-6">
											<label for="input2" class="form-label">Bridge Name</label>
											<input type="text" class="form-control" name="date" id="date" required>
										</div>
										<div class="col-md-6">
											<label for="input1" class="form-label">Status</label>
											<select class="form-select" name="worderType" id="worderType" required>
										...
										<div class="col-md-6">
											<label for="input2" class="form-label">Task Description </label>
											<input type="textfield" class="form-control" name="desc" id="desc" placeholder="Task Description ..." required>
										</div>
										<div class="col-md-6">
											<label for="input2" class="form-label">Starting Time</label>
											<input type="date" class="form-control" name="start" id="start" placeholder="" required>
										</div>
										<div class="col-md-6">
											<label for="input2" class="form-label">End Time</label>
											<input type="date" class="form-control" name="end" id="end" placeholder="" required>
										</div>
										<div class="col-md-6">
											<label for="input1" class="form-label">Assigned Personnel</label>
											<select class="form-select" name="assign" id="assign" required>
												<option selected>Choose...</option>
												<option value="said siad">said siad</option>
												<option value="masatu khamis">masatu khamis</option>
												<option value="happy michael">happy michael</option> 
											</select>
										</div>
										<div class="col-md-12">
