				...
				<div class="row col-12 col-lg-12">
					...
					<div class="card radius-10">
						<div class="card-body">
							...
							<form class="row g-3 pt-5" id="addAsset" method="POST" action="index.php?p=insertLvReport">
										<div class="col-md-6">
											<label for="input2" class="form-label">Transformer Name</label>
											<input type="text" class="form-control" name="trans" id="trans" placeholder="Tranformer name" required>
										</div>
										<div class="col-md-6">
											<label for="input2" class="form-label">Starting Date</label>
										...
										<div class="col-md-6">
											<label for="input2" class="form-label">No.of LV pole replaced</label>
											<input type="number" class="form-control" name="lvpole" id="lvpole"  required>
										</div>
										<div class="col-md-6">
											<label for="input2" class="form-label">No.of span 50mm Wornout Conductor Replaced</label>
											<input type="number" class="form-control" name="span" id="span" required>
										</div>
										<div class="col-md-6">
											<label for="input2" class="form-label">No.of Uprooted</label>
											<input type="number" class="form-control" name="up" id="up" required>
										</div>
										<div class="col-md-6">
											<label for="input2" class="form-label">No.of Serviceline 25mm replaced</label>
											<input type="number" class="form-control" name="serviceline" id="serviceline" required>
										</div>
										<div class="col-md-6">
											<label for="input2" class="form-label">No.of PG used</label>
