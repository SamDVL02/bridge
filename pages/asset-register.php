				...
				<div class="row col-12 col-lg-12">
					...
					<div class="card radius-10">
						<div class="card-body">
							...
							<form class="row g-3 pt-5" id="addAsset" method="POST" action="index.php?p=insertAsset">
										<div class="col-md-6">
											<label for="input2" class="form-label">Name of the Equipment</label>
											<select class="form-select" name="equipment" id="equipment" required>
												<option selected>Choose...</option>
												<option value="Excavator">Excavator</option>
												<option value="Bulldozers">Bulldozers</option>
												<option value="Skid loaders">Skid loaders</option>
												<option value="Backhoes">Backhoes</option>
												<option value="Cranes">Cranes</option>
												<option value="Aerial lifts">Aerial lifts</option>
												<option value="Beam launchers">Beam launchers</option>
										...
										<div class="col-md-6">
											<label for="input1" class="form-label">Conditon</label>
											<select class="form-select" name="asset" id="asset" required>
												<option selected>Choose...</option>
										...
										<div class="col-md-6">
											<label for="input2" class="form-label">License no</label>
											<input type="text" class="form-control" name="sn" id="sn" placeholder="type serial number" required>
										</div>
										<div class="col-md-6">
											<label for="input2" class="form-label">Type</label>
											<input type="text" class="form-control" name="pole" id="pole" placeholder="Type" required>
										</div>
										<div class="col-md-6">
