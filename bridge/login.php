...
if(isset($_POST["login"])){
    ...
    if(empty($username)||empty($password)) {
      ...
      // code for checking username and password from Database
       $data=Login_Attempt($username,$password);
       var_dump($data);
      if($data) {
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        <h5 class="card-title text-center pb-0 fs-4">ENHANCE AVAILABILITY PERFORMANCE OF STONE MASONRY ARCH BRIDGES</h5>
