                            ...
                            <?php
                                ...
                                while ($rows = $stmt->fetch()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>' . $rows["username"] . '</td>
                                        <td>' . $rows["email"] . '</td>
                                        <td><a href="deleteuser.php?id=' . $rows["id"] . '"><span class="btn btn-danger">Delete</span></a></td>
                                    </tr>';
                                }
                            ?>
                            </tbody>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form class="row g-3 needs-validation" novalidate method="POST" action="users.php">
                                            <div class="col-12">
